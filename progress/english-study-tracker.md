...
- [ ] **被动语态 (项目/系统类主语)**: project finished → was completed, 出现3次。项目/系统/产品作主语时必须被动。
- [ ] **反义疑问句 vs 一般疑问句**: "吧"=陈述句+tag，已累计3次写成一般疑问句。
...
7.  [ ] **19BEC Remaining**: 检查是否还有其他值得训练的语言点。
8.  [ ] **专项训练: 被动语态**: 项目/系统/产品类主语的被动语态专练。
9.  [ ] **专项训练: 反义疑问句**: "吧"=陈述句+tag 强化训练。
10. [ ] **重点关注**: 翻译时扫描情态词（需要/应该）+ 修饰词（得多/更/明天）。
11. [ ] **Review Drill**: 抽查虚拟语气 subjunctive were 和 Type 3 vs Mixed。
12. [ ] **Review Drill**: 抽查 `what it's like` 嵌套结构 和 否定句 any + 复数。
13. [ ] **Review Drill**: 验证 `spend + doing` 和 phrasal verb 宾语规则。