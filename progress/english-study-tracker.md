...
- [x] **反义疑问句 vs 一般疑问句**: ~~"吧"=陈述句+tag~~。2026-02-16 全场 tag question 稳定满分，知识缺口彻底修复 🏆
- [ ] **词性转换 (名词→形容词/副词)**: failure→failed, fast→quickly, 修饰名词时注意词性。
...
- [ ] **词汇搭配地道性**: finally→in the end, beautiful→attractive, cases→case studies, by→with justify, how much→how large workforce。
- [ ] **could have vs would have**: "早就买了"=would have(确定), 非 could have(可能)。
...
9.  [x] **专项训练: 反义疑问句**: ~~"吧"=陈述句+tag 强化训练。~~ ✅ 2026-02-16 全场稳定满分，彻底修复。
10. [ ] **重点关注**: 翻译时扫描情态词（需要/应该）+ 修饰词（得多/更/明天/早就/月）。2026-02-16 仍出现 3 次漏译。
11. [ ] **20BEC Remaining**: 检查 20BEC 是否还有其他值得训练的语言点。
12. [ ] **21BEC Start**: 进入 21BEC 新课文学习。
13. [ ] **Review Drill**: 抽查 hardly + tag question, subjunctive were。
14. [ ] **Review Drill**: 验证 `spend + doing` 和 phrasal verb 宾语规则。
15. [ ] **Review Drill**: 抽查 `what it's like` 嵌套结构 和 否定句 any + 复数。