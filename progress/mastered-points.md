...
| **coupled into** | 5 | 极高 | 2026-03-02 | 彻底攻克 Mixed Conditional 时态错位问题 🏆 |
...
| **somehow** | 5 | 极高 | 2026-03-07 | 准确区分"以某种方式"与"无论如何/总得"两种语义；虚拟语气融合自如 🏆 |
...
| **sooner rather than later** | 5 | 极高 | 2026-04-28 | 掌握其在建议/时间建议中的地道用法 |
...
| **ever** | 5 | 🟢 | 2026-05-13 | 归档（距首次学习 >14 天 + 🟢 + 多次正确复用） |
| **that side of** | 5 | 🟢 | 2026-05-13 | 归档（距首次学习 >14 天 + 🟢 + 多次正确复用） |
| **next week vs the next week** (时间参照点) | 5 | 🟢 | 2026-05-31 | 17BEC 提取；5 句式+QF 通关；不加 the 锚定现在，加 the 锚定过去 🏆 |
| **do the schedules** (do 表"制定/安排"义) | 5 | 🟡 | 2026-05-31 | 17BEC 提取；5 句式+QF 覆盖；`do` 搭配范围需巩固 |
| **delegator vs delegate vs delegatee** (角色名词区分) | 5 | 🟡 | 2026-05-31 | 17BEC 提取；5 句式+QF+1 轮加练；Tag 时态一致性关键性错误 1 次 |
| **must go** (must 表紧迫口语) | 5 | 🟢 | 2026-05-31 | 17BEC 提取；5 句式+QF 通关；must→had to 过去式转换正确 🏆 |
| **step in** | 10 | 🟢 | 2026-04-25 | 归档（>14 天 + 🟢 + 最近 3 次正确复用）🏆 |
| **run into (issues/problems)** | 10 | 🟢 | 2026-04-27 | 归档（>14 天 + 🟢 + 连续 2 次正确复用）🏆 |
| **rely on sb to do sth** | 10 | 🟢 | 2026-04-28 | 归档（>14 天 + 🟢）🏆 |
| **material (话题素材义)** | 10 | 🟢 | 2026-04-30 | 归档（不可数）🏆 |
| **a paper + noun** | 10 | 🟢 | 2026-04-30 | 归档（纸质 vs 电子）🏆 |
| **personally** | 10 | 🟢 | 2026-04-30 | 归档（句首/主语后位置）🏆 |
| **be limited to** | 10 | 🟢 | 2026-04-30 | 归档（Type 3 被动虚拟三层叠加无瑕疵）🏆 |
| **noise（讨论/反馈义）** | 10 | 🟢 | 2026-05-01 | 归档（不可数）🏆 |
| **in a nutshell / the nutshell is** | 10 | 🟢 | 2026-05-01 | 归档（a vs the 区分）🏆 |
| **be nailed down** | 10 | 🟢 | 2026-05-01 | 归档（完成时+被动+Tag）🏆 |
| **go with** | 10 | 🟢 | 2026-05-01 | 归档（全场最佳语言点）🏆 |
| **in place** | 10 | 🟢 | 2026-05-02 | 归档（已到位/已落实）🏆 |
| **hop on a meeting** | 10 | 🟢 | 2026-05-02 | 归档（5 句式全通关）🏆 |
| **plan out** | 10 | 🟢 | 2026-05-03 | 归档（代词位置 plan it out）🏆 |
| **ultimately** | 10 | 🟢 | 2026-05-03 | 归档（句首/助动词后位置正确）🏆 |
| **have something lined up** | 10 | 🟢 | 2026-05-03 | 归档（虚拟语气嵌套满分）🏆 |
| **per se** | 10 | 🟢 | 2026-05-03 | 归档（not... per se 结构）🏆 |
| **walk around the block** | 10 | 🟢 | 2026-05-04 | 归档（5 句式全通关+QF）🏆 |
| **a social setting** | 10 | 🟢 | 2026-05-04 | 归档（2 轮+QF 全对）🏆 |
| **at my own pace** | 10 | 🟢 | 2026-05-05 | 归档（3 轮核心+QF 全对）🏆 |
| **consume (knowledge/info)** | 10 | 🟢 | 2026-05-06 | 归档（核心用法正确+QF 满分）🏆 |
| **meet with sb** | 10 | 🟢 | 2026-05-06 | 归档（vs meet sb 辨析已掌握）🏆 |
| **high-level questions** | 10 | 🟢 | 2026-05-06 | 归档（vs low-level 对比正确）🏆 |
| **let alone + 原形** | 10 | 🟢 | 2026-05-06 | 归档（全程修复+隔夜满分）🏆 |
| **build A into B** | 10 | 🟢 | 2026-05-08 | 归档（6 种句式全部通关）🏆 |
| **talk shop** | 10 | 🟢 | 2026-05-08 | 归档（5 种句式+QF 满分）🏆 |
| **be past that** | 10 | 🟢 | 2026-05-08 | 归档（5 种句式通关+概念辨析）🏆 |
| **with (containing/including) 包含/附带义** | 7 | 🟡 | 2026-06-04 | 18BEC 提取；7 句式+QF 通关；`distraction` 词汇严重错误 1 次已修复；AI 题目设计不当 2 次 |
| **check + 省略 if/that (口语确认动词后)** | 6 | 🟡 | 2026-06-04 | 18BEC 提取；6 句式+QF 通关；零关键性错误；混合虚拟语气满分 🏆 |
