...
2. 使用场景区分 搭配 适用场景 侧重点 problem with 具体物品、服务、事件出问题 客观存在的 “故障 / 疏漏” problem about 抽象话题、议题有疑问 主观层面的 “疑问 / 讨论点” 
...
【老师说】 表达 核心含义 动作侧重 使用场景 read through the form 通读、从头到尾浏览表格 强调完整性、快速性，目的是整体了解内容 备考听力前快速熟悉表格结构；工作中快速过目表单要点 read the form 阅读表格 仅表示 “读” 的动作，无明确侧重 泛泛表达阅读表格的行为，不强调是否读完或读得快慢 例句对比
